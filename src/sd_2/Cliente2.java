...
public class Cliente2 extends javax.swing.JFrame
{
    ...
    static boolean coordenador = false;
    ...
    static int portaDesteCliente = 6000;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt)
    {
        try
        {
            ...
            {
                // Processo seguinte fora do anel
    ...
    public static void main(String args[]) throws IOException
    {
        ...
        // Declaração do Elemento Cliente 2
        final Cliente2 c = new Cliente2();
        c.jTextArea1.setText("PORTA DESTE CLIENTE: [" + portaDesteCliente + "].\n");

        /* 
         Se for o Coordenador, inicializa a transmissão do token. 
         Se não, envia mensagem de requisição
         */
        if (coordenador)
        {
            c.startToken();
