...
public class Cliente3 extends javax.swing.JFrame
{
     ...
     */
    static boolean coordenator = false;
...
// Function to start the token, passing it to the next process of the list
    ...
    public static void main(String args[]) throws IOException
    {
        ...
        /* 
         * If it is the coordenator, inicialize token transimission. If it is not, 
